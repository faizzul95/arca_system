<img src="<?php echo $icon ?>" title="<?php echo lang('request') ?>" alt="<?php echo lang('request') ?>" /> <?php echo lang('request') . ' : ' . $controller . '/' . $action ?>
    ...
    <?php if (count($parameters) > 0) : ?>
        ...
        <p>
            <span class="right-col" style="float:none">
                <pre style="color:#FFF"><?php echo   print_r($parameters, true) ?></pre>
            </span>
        </p>
    <?php endif ?>
</div>