								...
								<div class="p-2 mt-4">
									<form id="formAuthentication" method="POST">
										...
										<div class="mb-3">
											...
											<input type="text" class="form-control" id="username" name="username" placeholder="Enter username / email / matric no." autocomplete="off">
										</div>

										<div class="mb-3">
											<div class="float-end">
												<a href="<?= url('auth/forgot-password') ?>" class="text-muted">Forgot password?</a>
											</div>
