                    ...
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 pt-4">
                            <div class="mb-5 text-white-50">
                                <h1 class="display-5 coming-soon-text">403 Unauthorized Access</h1>
                                <div class="mt-4 pt-2">
                            ...
                            <div class="row justify-content-center mb-5">
                                <div class="col-xl-4 col-lg-8">
                                    <div>
                                        <img src="<?= asset('custom/img/nodata/403.png') ?>" alt="" width="250%" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
