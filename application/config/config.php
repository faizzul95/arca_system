...
if (is_cli()) {
	$path = 'http://localhost/arca_system/';
} else {
...
|
*/
$config['encryption_key'] = 'mohdfahmyizwan05!4';
...
$config['sess_save_path'] = FCPATH . "application" . DIRECTORY_SEPARATOR . "cache" . DIRECTORY_SEPARATOR . "ci_session";;
...
$config['csrf_token_name'] = 'arcaSecurityCsrf';
$config['csrf_cookie_name'] = 'arcaCookieSecurityCsrf';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = TRUE;
$config['csrf_exclude_uris'] = array(
	'event/list-event',
	'event/list-event-organizer',
	'attendance/list-attendance-slot',

	'profile/list-profile-userid',
	'profile/list-all-organizer',

	'applications/list-application-admin',
	'applications/list-application-srk',

	'college/list-college',
	'college/list-room',

	'academic/list-academic',

	'management/list-education',
	'management/list-faculty',
	'management/list-program',
	'management/list-college-level',
	...
	'rbac/list-backup-db',
	'rbac/list-abilities',
	'rbac/list-email-queue',
	'rbac/list-email-template',
